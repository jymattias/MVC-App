...
namespace MVCApp.Controllers
{
    public class EscuelaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AñoDeCreacion,Pais,Ciudad,Direccion,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AñoDeCreacion,Pais,Ciudad,Direccion,TipoEscuela,Id,Nombre")] Escuela escuela)
        {
            if (id != escuela.Id)
            {
                return NotFound();
